...
{
    [Activity(Label = "Scan Voucher Codes", MainLauncher = false, Icon = "@drawable/ic_launcher")]
    public class VoucherCodeActivity : Activity, IAnylineOcrListener
    {
        ...
        void IAnylineOcrBaseListener.OnResult(AnylineOcrResult result)
        {
            ...
            _voucherCodeResultView.ResultText.Text = result.Text.Trim();
        }
