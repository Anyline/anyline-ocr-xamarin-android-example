...
{
    [Activity(Label = "Scan Bottlecaps", MainLauncher = false, Icon = "@drawable/ic_launcher")]
    public class BottlecapActivity : Activity, IAnylineOcrListener
    {
        ...
        void IAnylineOcrBaseListener.OnResult(AnylineOcrResult result)
        {
            ...
            _bottlecapResultView.ResultText.Text = result.Text.Trim();
        }
